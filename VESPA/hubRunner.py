...
from qgis.PyQt.QtWidgets import QWidget, QDialogButtonBox, QLabel, QMessageBox
...
#        self.setWindowIcon(QWidget.QIcon('web.png')) ## <= MM: What is this??
    ...
    def showDialog(self):
        ...
        reply = QMessageBox.question(self, 'Continue?', text, QMessageBox.Yes, QMessageBox.No)
